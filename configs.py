...
class Config(object):
    ...
    USER_SESSION_STRING = os.getenv("USER_SESSION_STRING", "1BVtsOKkBu09sVLlkjhtgdfcgbjnmjhvgGQQnQZp81QLu_hvbfV9yEuhmccZdjyWtbbXB-m2ujGrZ8HY9RymfBfBDrrZqChCCLSXWhZ54D8FCVpkiAO1GI-c85ZDExvGUu_3g-QdoqL7Kf-K6tK4I-u8CmeNmQKXLO-jPS89BphFytogqFKYCNvv7Kw2WOlbcEzsijo5xFYFWmVsccKPGdgGL9xvWTB-51uH36joGzuBnT6TGMftMGmUK5DQQF5i6Lk2_0EknKBN5Q3YpP_JNiOl9PntcvYHPUkgecupU2m5DKi5TMwHgI5ohFMezIrHH0NNG63AHYf35UGSienCWbwG8Csn8VceLQMnXrKZcRbIy-McIY=")
#   Channel id where your posts are stored.
    ...
    BOT_OWNER = int(os.getenv("BOT_OWNER", "5965340120"))
...
#   id of update channel
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1001782487965")
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://laxxy:laxxy@lazxxdev.lpvunl5.mongodb.net/?retryWrites=true&w=majority")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", ""))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "True")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "real_MoviesAdda2")
    FORCE_SUB = os.getenv("FORCE_SUB", "True")
    AUTO_DELETE_TIME = int(os.getenv("AUTO_DELETE_TIME", 120))
    MDISK_API = os.getenv("MDISK_API", "60puV1RVAqVWHWB3V1CR")
